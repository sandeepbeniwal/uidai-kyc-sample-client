 ...
 *       &lt;attribute name="pi" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *       &lt;attribute name="pa" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *       &lt;attribute name="pfa" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *       &lt;attribute name="bio" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *       &lt;attribute name="bt" type="{http://www.w3.org/2001/XMLSchema}string" /&gt;
 *       &lt;attribute name="pin" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *       &lt;attribute name="otp" use="required" type="{http://www.uidai.gov.in/authentication/uid-auth-request/2.5}UsesFlag" /&gt;
 *     &lt;/restriction&gt;
 *   &lt;/complexContent&gt;
 * &lt;/complexType&gt;
 * </pre>
