...
<xsl:stylesheet version="1.1"
 ...
 xmlns:ascii="in.gov.uidai.auth.sampleapp.common.UnicodeUitls"
 xmlns:font="in.gov.uidai.auth.sampleapp.common.LanguageCodeFontStore"
 exclude-result-prefixes="fo">
 <xsl:output method="xml" version="1.0"  omit-xml-declaration="no"
  indent="yes" />
 <xsl:param name="imageData" select="KycRes/UidData/Pht" />
 <xsl:param name="langCode" select="/KycRes/UidData/LData/@lang"/>
    ...
    <fo:flow flow-name="xsl-region-body">
     ...
     <fo:block font-size="10pt" space-after="5mm">
      <xsl:attribute name="font-family">
         <xsl:value-of select="font:getFontNameByLanguageCode($langCode)"></xsl:value-of>
      </xsl:attribute>
      <xsl:apply-templates select="KycRes/UidData/LData"></xsl:apply-templates>
     </fo:block>
